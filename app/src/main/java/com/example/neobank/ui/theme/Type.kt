...
// Replace with your custom fonts if you have them, otherwise system fonts will be used.
// Example:
...
val AppTypography = Typography(
    ...
    headlineMedium = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.SemiBold, // Neo banks often use slightly bolder headlines
        fontSize = 28.sp,
        lineHeight = 36.sp,
        letterSpacing = 0.sp
    ),
